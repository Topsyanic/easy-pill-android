...
import com.cb008264.easy_pill_android.RegisterDoctorActivity;
...
import static com.cb008264.easy_pill_android.admin.AdminDoctorsFragment.doctorAdapter;
import static com.cb008264.easy_pill_android.admin.AdminPharmacistsFragment.pharmacistAdapter;

public class AdminAddDoctorActivity extends AppCompatActivity implements View.OnClickListener {
    private TextView firstNameText, lastNameText, emailText, passwordText, confirmPasswordText, contactText, addressText,expertiseText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstNameText = findViewById(R.id.addDoctor_firstNameText);
        lastNameText = findViewById(R.id.addDoctor_lastNameText);
        emailText = findViewById(R.id.addDoctor_emailText);
        contactText = findViewById(R.id.addDoctor_contactText);
        addressText = findViewById(R.id.addDoctor_addressText);
        passwordText = findViewById(R.id.addDoctor_passwordText);
        confirmPasswordText = findViewById(R.id.addDoctor_passwordText2);
        expertiseText = findViewById(R.id.addDoctor_expertiseText);
        registerBtn = findViewById(R.id.addDoctor_registerBtn);
        registerBtn.setOnClickListener(this);
        progressBar = findViewById(R.id.addDoctor_progressBar);
    }
    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.addDoctor_registerBtn:
                try {
                    registerUser();
    ...
    public void registerUser() throws JSONException {
        ...
        String expertise = expertiseText.getText().toString().trim();
        ...
        if (expertise.isEmpty()) {
            expertiseText.setError("Expertise cannot be blank");
            expertiseText.requestFocus();
            return;
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                doctorAdapter.addItem(user);
                Toast.makeText(AdminAddDoctorActivity.this,"Account Created Successfully",Toast.LENGTH_LONG).show();
                progressBar.setVisibility(View.GONE);
                finish();
            }
...
//                Log.e("Rest Response",response.toString());
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AdminAddDoctorActivity.this, "Invalid Details", Toast.LENGTH_LONG).show();
                        progressBar.setVisibility(View.GONE);
                    }
                }
