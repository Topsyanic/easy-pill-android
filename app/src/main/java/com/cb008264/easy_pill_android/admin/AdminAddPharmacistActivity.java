...
public class AdminAddPharmacistActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_pharmacist);
        firstNameText = findViewById(R.id.addPharmacist_firstNameText);
        lastNameText = findViewById(R.id.addPharmacist_lastNameText);
        emailText = findViewById(R.id.addPharmacist_emailText);
        contactText = findViewById(R.id.addPharmacist_contactText);
        addressText = findViewById(R.id.addPharmacist_addressText);
        passwordText = findViewById(R.id.addPharmacist_passwordText);
        confirmPasswordText = findViewById(R.id.addPharmacist_passwordText2);
        registerBtn = findViewById(R.id.addPharmacist_registerBtn);
        registerBtn.setOnClickListener(this);
        progressBar = findViewById(R.id.addPharmacist_progressBar);
    }
    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.addPharmacist_registerBtn:
                try {
                    registerUser();
    ...
    private void registerUser() throws JSONException {
        ...
        jsonBody.put("userRole", "pharmacist");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                pharmacistAdapter.addItem(user);
                Toast.makeText(AdminAddPharmacistActivity.this,"Pharmacist Added Successfully",Toast.LENGTH_LONG).show();
                progressBar.setVisibility(View.GONE);
                finish();
            }
...
//                Log.e("Rest Response",response.toString());
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AdminAddPharmacistActivity.this, "Invalid Details", Toast.LENGTH_LONG).show();
                        progressBar.setVisibility(View.GONE);
                    }
                }
