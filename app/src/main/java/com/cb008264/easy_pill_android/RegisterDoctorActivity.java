    ...
    public void registerUser() throws JSONException {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(RegisterDoctorActivity.this,"Account Created Successfully",Toast.LENGTH_LONG).show();
                progressBar.setVisibility(View.GONE);
...
//                Log.e("Rest Response",response.toString());
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RegisterDoctorActivity.this, "Invalid Details", Toast.LENGTH_LONG).show();
                        progressBar.setVisibility(View.GONE);
                    }
                }
